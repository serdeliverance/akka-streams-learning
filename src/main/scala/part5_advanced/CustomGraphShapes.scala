...
object CustomGraphShapes extends App {
  ...
  case class Balance2x3 (
    ...
    // 2 - define inlet/outlets
    // Inlet[T], Outlet[T]      ...these are the classes for the ports
  ...
  // 3 - implement the component... it return your own shape
  ...
  // 4 - use your component in a runnable graph
